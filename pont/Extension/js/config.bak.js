...
right_panel.Display = function() {
	...
	for (var i = 0; i < lim; i++) {
		...
		elem_t.id = "tower_" + i;
		//var inner = "<h1><span>" + tower[name] + "</span><a title='Eliminar torre' class='edit del_tower'  id='del_tower_" + i + "'>x</a><a title='Añadir sección' class='edit add_section'  id='add_section_" + i + "'>+</a></h1>";
		var inner = "<h1><span>" + tower[name] + "</span></h1>";
		//inner += "<div class='col'>";
	...
	if (false && location.hash == "#config/edit") {
